...
//		   		    "Dear %s,\n\n" +
//		   		    "Your complaint has  Booked.\n\n" +
//		   		    		"Event Name : %s, \n\n"+ 
//		   		    "Event Date : %s, \n \n"+
//		   		    "Best regards,\n" +
//		   		    "Vidhu & Team",
//		   		 updatedStatus.getComplainant().getEmail().split("@")[0],
//		   		updatedStatus.getComplainant().getName(),
//		   		updatedStatus.getIncidentType(),
//		   		updatedStatus.getIncidentDescription()
//		   		   
//		   		);
//
